...
//
///**
// * Scala compiler for Scala 2.9.x.
// *
// * @author Galder Zamarreño
// * @see This code is based on <a href="https://github.com/twitter/util">
// *         Twitter's Eval util class.</a>
// */
//class Compiler(target: Option[File]) {
//
//   import Compiler._
//
//   /**
...
//    * Will generate a classname of the form Evaluater<unique>,
